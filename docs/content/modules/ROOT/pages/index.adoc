...
* **Play with reasoning models** — use `/think` and `/no_think` prompting to control LLM reasoning behavior in a live AI agent
...
* LLM reasoning capabilities (`/think`, `/no_think`)
